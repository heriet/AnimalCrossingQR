/*
 * Almost all copy of com.google.zxing.qrcode.QRCodeReader
 ...
 */
package info.heriet.zxing.qrcode.decoder
{
    ...
    public class StructuredQRCodeReader implements Reader
    { 

          private static var  NO_POINTS:Array = new Array(0);
          private var decoder:StructuredQRCodeDecoder = new StructuredQRCodeDecoder();

  public function reset():void {
    // do nothing
  }
  
          protected function getDecoder():StructuredQRCodeDecoder 
          {
            return decoder;
          }
